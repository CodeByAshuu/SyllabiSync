...
$query = "SELECT * FROM syllabus_approvals WHERE status = 'Approved' LIMIT $limit OFFSET $offset";
$result = mysqli_query($conn, $query);

// Fetch total number of rows for pagination
$total_query = "SELECT COUNT(*) as total FROM syllabus_approvals WHERE status = 'Approved'";
...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="bg-blue-800 w-72 flex flex-col text-white p-6">
        ...
        <nav class="mt-6 space-y-4">
            ...
            <a href="approvedCurriculum.php" class="flex items-center gap-4 p-3 bg-blue-600 rounded-lg"><i class="fa-solid fa-check"></i> Approved Curriculum</a>
    ...
    <div class="flex-1 p-8 overflow-y-auto">
        <h1 class="text-4xl font-bold text-gray-800">Approved Curriculum</h1>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center gap-3">
                                    <form method="GET" action="view_pdf.php" target="_blank">
                                        ...
                                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md">View</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
